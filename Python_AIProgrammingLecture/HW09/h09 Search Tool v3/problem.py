...
class Numeric(Problem):
    ...
    def report(self):
        ...
        print("Minimum value: {0:,.3f}".format(self._valueC))
        Problem.report(self)

    def coordinate(self):
        c = [round(value, 3) for value in self._current]
...
class Tsp(Problem):
    ...
    def report(self):
        ...
        print("Minimum tour cost: {0:,}".format(round(self._valueC)))
        Problem.report(self)
